        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center group">
              ...
              <span className="ml-4 text-2xl font-bold text-black modern-heading">ultima-rat.io</span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex space-x-12">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="text-gray-600 hover:text-[#0395A6] px-4 py-2 text-base font-medium transition-all duration-300 border-b-2 border-transparent hover:border-[#0395A6] modern-focus relative group"
              >
                {item.name}
          ...
          <div className="hidden md:flex">
            <a
              ...
              className="modern-button px-8 py-3 rounded-lg text-base font-semibold modern-focus group"
            >
