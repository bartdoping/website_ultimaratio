        ...
        <div className="academic-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="premium-card p-8 text-center animate-fade-in-up">
              ...
              <h3 className="text-lg font-bold text-black mb-4">Buchung und Themenwahl</h3>
            ...
            <div className="premium-card p-8 text-center animate-fade-in-up">
              ...
              <h3 className="text-lg font-bold text-black mb-4">Live-Coaching per Zoom</h3>
              <p className="text-gray-600 leading-relaxed premium-text">
            ...
            <div className="premium-card p-8 text-center animate-fade-in-up">
              ...
              <h3 className="text-lg font-bold text-black mb-4">PDF mit Protokoll & Material</h3>
              <p className="text-gray-600 leading-relaxed premium-text">
            ...
            <div className="premium-card p-8 text-center animate-fade-in-up">
              ...
              <h3 className="text-lg font-bold text-black mb-4">Du lernst fokussiert, nachhaltig</h3>
              <p className="text-gray-600 leading-relaxed premium-text">
