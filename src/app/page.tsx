      ...
      <section className="modern-section bg-white">
        <div className="modern-container">
          <div className="text-center modern-spacing">
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-12 modern-heading modern-animate-fade-in-up">
              Der <span className="text-[#0395A6]">ultima-rat.io</span> Ansatz
            </h2>
            <p className="text-2xl text-gray-600 max-w-5xl mx-auto modern-text modern-animate-fade-in-up">
          ...
          <div className="modern-grid modern-grid-2 gap-12">
            <div className="modern-card p-12 modern-animate-fade-in-up">
              ...
              <h3 className="text-3xl font-bold text-black mb-6 modern-heading">Wissenschaftliche Grundlage</h3>
              <p className="text-xl text-gray-600 leading-relaxed modern-text break-words mobile-readable-text">
            ...
            <div className="modern-card p-12 modern-animate-fade-in-up">
              ...
              <h3 className="text-3xl font-bold text-black mb-6 modern-heading">Strukturierte Herangehensweise</h3>
              <p className="text-xl text-gray-600 leading-relaxed modern-text break-words mobile-readable-text">
        ...
        <div className="modern-container">
          ...
          <div className="modern-grid modern-grid-2 gap-12">
            <div className="modern-card p-16 text-center modern-animate-fade-in-up price-card-mobile-extend">
              ...
              <h3 className="text-4xl font-bold text-black mb-8 modern-heading">Einzelcoaching</h3>
              <div className="text-8xl font-bold text-[#0395A6] mb-8 price-mobile">39€</div>
              <p className="text-2xl text-gray-600 mb-10 modern-text price-text-mobile">
              ...
              <a
                ...
                className="modern-button px-12 py-6 rounded-lg text-2xl font-semibold modern-focus group price-button-mobile"
              >
            ...
            <div className="modern-card p-16 text-center modern-animate-fade-in-up">
              ...
              <h3 className="text-4xl font-bold text-black mb-8 modern-heading">Gruppencoaching</h3>
              <div className="text-8xl font-bold text-[#0395A6] mb-8">25€</div>
              <p className="text-2xl text-gray-600 mb-10 modern-text">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="modern-button px-12 py-6 rounded-lg text-2xl font-semibold modern-focus group"
              >
                <MessageCircle className="w-6 h-6 mr-3 inline-block group-hover:animate-pulse" />
                Jetzt buchen
                <ArrowRight className="w-6 h-6 ml-3 inline-block group-hover:translate-x-1 transition-transform" />
      ...
      <section className="modern-section bg-[#0395A6] text-white">
        <div className="modern-container">
          <div className="text-center modern-animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-12 modern-heading">
              Bereit für deinen <span className="text-white">Prüfungserfolg?</span>
            </h2>
            <p className="text-2xl text-white mb-16 max-w-4xl mx-auto modern-text">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#0395A6] hover:bg-[#028A9A] text-white px-16 py-8 rounded-lg text-2xl font-bold transition-all duration-300 hover:scale-[1.02] shadow-lg hover:shadow-xl inline-flex items-center justify-center space-x-4"
              >
              ...
              <Link
                href="/coaching"
                className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border-2 border-white/50 hover:border-white px-16 py-8 rounded-lg text-2xl font-bold transition-all duration-300 inline-flex items-center justify-center space-x-4"
              >
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="font-bold text-2xl mb-4">Kostenlos</h3>
                <p className="text-white/80 text-lg">Erstgespräch ohne Verpflichtung</p>
              </div>
              <div className="text-center">
                <CheckCircle className="w-12 h-12 text-white mx-auto mb-6" />
                <h3 className="font-bold text-2xl mb-4">Flexibel</h3>
                <p className="text-white/80 text-lg">Termine nach deinem Zeitplan</p>
              </div>
              <div className="text-center">
                <CheckCircle className="w-12 h-12 text-white mx-auto mb-6" />
                <h3 className="font-bold text-2xl mb-4">Erfolgreich</h3>
                <p className="text-white/80 text-lg">97% bestehen ihre Prüfungen</p>
              </div>
            </div>
          </div>
        </div>
