      ...
      <section className="modern-hero modern-section">
        <div className="modern-container">
          <div className="text-center">
            ...
            {/* Trust Indicators */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-4xl mx-auto modern-animate-fade-in-up">
        ...
        <div className="modern-container">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="modern-card p-6 md:p-16 modern-animate-fade-in-up">
              ...
              <div className="modern-grid modern-grid-2 px-5 md:px-0">
                <div>
                  ...
                  <p className="text-xs md:text-lg text-gray-600 leading-relaxed modern-text mb-3 md:mb-6 px-5 md:px-0 break-words">
                  ...
                  <p className="text-xs md:text-lg text-gray-600 leading-relaxed modern-text px-5 md:px-0 break-words">
