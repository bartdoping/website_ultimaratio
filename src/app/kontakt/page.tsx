          ...
          <div className="modern-grid modern-grid-2">
            <div className="modern-card p-8 md:p-12 text-center modern-animate-fade-in-up">
              <div className="flex items-center justify-center mx-auto mb-6 md:mb-8">
                <MessageSquare className="w-12 h-12 md:w-16 md:h-16 text-[#0395A6]" />
              </div>
              <h3 className="text-base md:text-lg font-bold text-black mb-4 md:mb-6 modern-heading">WhatsApp</h3>
              ...
              <a
                ...
                className="modern-button px-6 md:px-8 py-3 md:py-4 rounded-lg text-sm md:text-lg font-semibold modern-focus inline-block"
              >
                WhatsApp öffnen
              </a>
            </div>
            ...
            <div className="modern-card p-8 md:p-12 text-center modern-animate-fade-in-up">
              <div className="flex items-center justify-center mx-auto mb-6 md:mb-8">
                <MailOpen className="w-12 h-12 md:w-16 md:h-16 text-[#0395A6]" />
              </div>
              <h3 className="text-base md:text-lg font-bold text-black mb-4 md:mb-6 modern-heading">E-Mail</h3>
              <p className="text-sm md:text-lg text-gray-600 leading-relaxed modern-text mb-4 md:mb-6">
                Schreib uns eine E-Mail. Wir antworten innerhalb von 24 Stunden.
              </p>
              <a
                href="mailto:info@ultima-rat.io"
                className="modern-button-secondary px-6 md:px-8 py-3 md:py-4 rounded-lg text-sm md:text-lg font-semibold modern-focus inline-block"
              >
                info@ultima-rat.io
              </a>
            </div>
        ...
        <div className="modern-container">
          ...
          <div className="modern-grid modern-grid-2">
            <div className="modern-card p-8 md:p-12 modern-animate-fade-in-up">
              <h3 className="text-base md:text-lg font-bold text-black mb-6 md:mb-8 modern-heading">Kontakt</h3>
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-center">
                  <MapPin className="w-5 h-5 md:w-6 md:h-6 text-[#0395A6] mr-3 md:mr-4 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-black text-sm md:text-base">Adresse</p>
                    <p className="text-gray-600 text-sm md:text-base">Warburghof 14, 30627 Hannover, Deutschland</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <Phone className="w-5 h-5 md:w-6 md:h-6 text-[#0395A6] mr-3 md:mr-4 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-black text-sm md:text-base">Telefon</p>
                    <p className="text-gray-600 text-sm md:text-base">+49 163 9347633</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <Mail className="w-5 h-5 md:w-6 md:h-6 text-[#0395A6] mr-3 md:mr-4 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-black text-sm md:text-base">E-Mail</p>
                    <p className="text-gray-600 text-sm md:text-base">info@ultima-rat.io</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <Clock className="w-5 h-5 md:w-6 md:h-6 text-[#0395A6] mr-3 md:mr-4 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-black text-sm md:text-base">Erreichbarkeit</p>
                    <p className="text-gray-600 text-sm md:text-base">Mo-So: 00:00-24:00 Uhr</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="modern-card p-8 md:p-12 modern-animate-fade-in-up">
              <h3 className="text-base md:text-lg font-bold text-black mb-6 md:mb-8 modern-heading">Schnellkontakt</h3>
              <div className="space-y-4 md:space-y-6">
                <a
                  href="http://wa.me/491639347633"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center p-3 md:p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-all group"
                >
                  <MessageCircle className="w-5 h-5 md:w-6 md:h-6 text-green-600 mr-3 md:mr-4" />
                  <div>
                    <p className="font-semibold text-black text-sm md:text-base">WhatsApp</p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center p-3 md:p-4 bg-pink-50 rounded-lg hover:bg-pink-100 transition-all group"
                >
                  <Instagram className="w-5 h-5 md:w-6 md:h-6 text-pink-600 mr-3 md:mr-4" />
                  <div>
                    <p className="font-semibold text-black text-sm md:text-base">Instagram</p>
                    <p className="text-gray-600 text-xs md:text-sm">Direkter Kontakt</p>
                  </div>
                </a>
                <a
                  href="mailto:info@ultima-rat.io"
                  className="flex items-center p-3 md:p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-all group"
                >
                  <Mail className="w-5 h-5 md:w-6 md:h-6 text-purple-600 mr-3 md:mr-4" />
                  <div>
                    <p className="font-semibold text-black text-sm md:text-base">E-Mail</p>
